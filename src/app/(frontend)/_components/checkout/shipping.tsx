...
// import { setShippingMethod } from "@/app/api/services/cart";
import { calculatePriceForShippingOption } from "@/app/api/services/fulfillment";
          ...
          <div className="grid">
            ...
            <div data-testid="delivery-options-container">
              <div className="pb-8 md:pt-0 pt-2">
                ...
                <RadioGroup
                  onChange={(v: any) => handleSetShippingMethod(v, "shipping")}
          ...
          {showPickupOptions === PICKUP_OPTION_ON && (
            <div className="grid">
              ...
              <div data-testid="delivery-options-container">
                <div className="pb-8 md:pt-0 pt-2">
                  <RadioGroup
                    onChange={(v: any) => handleSetShippingMethod(v, "pickup")}
                    value={shippingMethodId}
                  >
