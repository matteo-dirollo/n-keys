...
const Dashboard = async (_props: AdminViewServerProps) => {
      ...
      >
        <li>
          <Card>
            ...
            <CardBody>{formatCurrency(currentMetrics.totalProfit)}</CardBody>
            <CardFooter>
        ...
        <li>
          <Card>
            ...
            <CardBody>{formatCurrency(currentMetrics.avgOrderValue)}</CardBody>
            <CardFooter>
              {calculatePercentageChange(
        ...
        <li>
          <Card>
            ...
            <CardBody>{currentMetrics.totalOrders.toString()}</CardBody>
            <CardFooter>
              {calculatePercentageChange(
        ...
        <li>
          <Card>
            ...
            <CardBody>{formatCurrency(currentMetrics.lifetimeValue)}</CardBody>
            <CardFooter>
              {calculatePercentageChange(
